    ...
    <main class="site-content">
        <section>
            <div class="section-container">
                ...
                <p>
                    <strong>Finder</strong>JS allows you to browse tree-like data in columns, similar to OS X's file manager
                    <a href="https://en.wikipedia.org/wiki/Finder_(software)">Finder<span class="fa fa-external-link"></span></a
            >.
          </p>
          <h3>Features</h3>
          <ul>
  ...
  .on('leaf-selected', function(item) {
    console.log('Leaf node selected', item);
          ...
          <p>
            ...
            <a href="https://github.com/mynameistechno/finderjs">README</a> or view the source of the
                    <a href="https://github.com/mynameistechno/finderjs/tree/master/example">examples</a
            >
            above.
          </p>
        </div>
    ...
    <footer class="footer">
      ...
      <p>
        Created by <a href="https://mynameistechno.github.io/">Mark Matyas</a>. Source code released under the
                    <a href="https://raw.githubusercontent.com/mynameistechno/finderjs/master/LICENSE">MIT license</a
        >.
      </p>
